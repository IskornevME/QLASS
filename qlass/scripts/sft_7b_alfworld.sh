...
OUT_DIR=/home/m.iskornev/qlass/models/qlass-Llama-2-7b-chat-hf-alfworld-sft_run1
...
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.run --nproc_per_node=${node_num} --master_port=20001 qlass/train_sft.py \
